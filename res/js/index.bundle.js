...
/******/ 	return __webpack_require__(__webpack_require__.s = "./res/js/index.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TaskContainer; });
...
function (_React$Component) {
  _inherits(TaskInput, _React$Component);

  function TaskInput(props) {
    _classCallCheck(this, TaskInput);

    return _possibleConstructorReturn(this, _getPrototypeOf(TaskInput).call(this, props));
  }
  ...
  _createClass(TaskInput, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        className: "uk-button-group uk-width-1-1 uk-child-width-1-3"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        ...
        onClick: this.props.handleChangeColor,
        "data-value": "default"
      }, "Light"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        ...
        className: "uk-tile uk-padding-small uk-card uk-card-body uk-card-".concat(task.color)
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", {
        className: "uk-text-center"
      }, task.title || 'Enter title')))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "uk-margin"
...
function (_React$Component2) {
  ...
  function Task(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Task).call(this, props));
  }
  ...
  _createClass(Task, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        className: "uk-card uk-card-body uk-card-".concat(task.color, " uk-inline uk-transition-toggle")
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", {
        className: "uk-text-center uk-margin-auto-vertical"
      }, task.title), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "uk-transition-fade uk-overlay uk-overlay-primary uk-position-cover"
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "uk-transition-fade uk-overlay uk-overlay-primary uk-position-cover"
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "uk-transition-fade uk-overlay uk-overlay-primary uk-position-cover"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "uk-text-break uk-position-top-left uk-margin-small-top uk-margin-small-left uk-width-5-6"
      }, task.description || 'No description'), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "uk-position-bottom-right uk-margin-small-bottom uk-margin-small-right"
...
function (_React$Component3) {
  _inherits(TaskContainer, _React$Component3);
  ...
  _createClass(TaskContainer, [{
    ...
    value: function createTask(e) {
      ...
      promise.then(function (res) {
        if (res.status !== 200) return _this3.setState({
        ...
        var newTask = JSON.parse(res.responseText);
    ...
    value: function updateTask(e) {
      ...
      var modifiedTask = this.state.task;
      var tasks = this.state.tasks;
      var promise = new Promise(function (resolve, reject) {
        var xhr = new XMLHttpRequest();
        xhr.open('PUT', "/api/tasks/".concat(sequence));
      ...
      promise.then(function (res) {
        ...
        var title = modifiedTask.title,
            description = modifiedTask.description,
            color = modifiedTask.color;
        task.title = title;
    ...
    value: function deleteTask(task) {
      ...
      var promise = new Promise(function (resolve, reject) {
        var xhr = new XMLHttpRequest();
        xhr.open('DELETE', "/api/tasks/".concat(task.sequence));
    ...
    value: function doneTask(task) {
      ...
      var promise = new Promise(function (resolve, reject) {
        var xhr = new XMLHttpRequest();
        xhr.open('PUT', "/api/tasks/".concat(task.sequence));
    ...
    key: "handleModify",
    value: function handleModify(task) {
    ...
    value: function render() {
      ...
      var taskList = tasks.map(function (task) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Task, {
          key: task._id,
          task: task,
          onDone: function onDone() {
            return _this7.doneTask(task);
          },
          onModify: function onModify() {
            return _this7.handleModify(task);
          },
          onDelete: function onDelete() {
            return _this7.deleteTask(task);
          }
        });
      });
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(TaskInput, {
        ...
        className: "uk-button uk-button-default uk-width-1-1 uk-height-1-1 uk-padding",
        "uk-toggle": "target: #taskModal"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "uk-margin-small-right",
...
/* harmony import */ var _components_tasks_jsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/tasks.jsx */ "./res/js/components/tasks.jsx");
/* eslint-disable no-unused-vars */
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_tasks_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], null), document.getElementById('taskContainer'));
